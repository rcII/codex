...
client_request_definitions! {
    ...
    #[experimental("thread/turns/listPaginated")]
    ThreadTurnsListPaginated => "thread/turns/listPaginated" {
        params: v2::ThreadTurnsListPaginatedParams,
        // Strict persisted-history read; never falls back to rollout replay.
        serialization: None,
        response: v2::ThreadTurnsListPaginatedResponse,
    },
    ...
    #[experimental("thread/items/listPaginated")]
    ThreadItemsListPaginated => "thread/items/listPaginated" {
        params: v2::ThreadItemsListPaginatedParams,
        // Strict persisted-history read; never falls back to rollout replay.
        serialization: None,
        response: v2::ThreadItemsListPaginatedResponse,
    },
